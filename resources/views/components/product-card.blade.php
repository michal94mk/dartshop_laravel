...
<div class="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
    ...
    <div class="p-4">
        ...
        <h3 class="mt-1 text-lg font-medium text-gray-900 truncate">{{ $product->name }}</h3>
        ...
        <div class="mt-2 flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                <button type="button" class="p-1.5 rounded-full text-gray-500 hover:text-gray-700 hover:bg-gray-100" data-tooltip="Szybki podgląd">
                    <span class="sr-only">Szybki podgląd</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
