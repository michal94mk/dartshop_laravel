                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('admin.brands.edit', ['brand' => $brand->id, 'tailwind' => 1]) }}" class="text-indigo-600 hover:text-indigo-900">Edytuj</a>
