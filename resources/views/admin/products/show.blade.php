    ...
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('admin.products.edit', ['product' => $product->id]) }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded shadow-sm">
                    <i class="fas fa-edit mr-1"></i> Edytuj
                </a>
                <a href="{{ route('admin.products.index') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded shadow-sm">
