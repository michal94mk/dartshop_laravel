...
class SocialAuthController extends BaseApiController
{
    ...
    public function redirectToGoogle(): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'Redirecting to Google OAuth');
        }
    }
    ...
    public function handleGoogleCallback(Request $request): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'Handling Google OAuth callback');
        }
    }
    ...
    public function loginWithGoogle(Request $request): JsonResponse
    {
        try {
            ...
            return $this->handleException($e, 'Login with Google (frontend)');
        }
    }
